...
const ToolBar = ({
  ...
  const classNamesBrashButtons = (value: 'brush' | 'line') =>
    cn('flex justify-center rounded-md p-1 active:border-white  border-2 border-solid', {
      'border-orange-500': value !== brush,
      'border-white': value === brush,
    });

  return (
    <div>
      <div className="w-max h-max bg-orange-500 rounded-md rounded-r-none shadow-md shadow-orange-800">
        <div className="flex justify-center rounded-md p-1 active:border-white  border-orange-500 border-2 border-solid">
        ...
        <div className="bg-orange-500 rounded-md">
          ...
          <div
            ...
            } w-32 left-24 h-31 p-1 border-solid border-white border-2 rounded-md bg-orange-300 bg-gradient-to-l from-orange-500`}>
        ...
        <div className="bg-orange-500 rounded-md">
          <button onClick={brushHundler('brush')} className={classNamesBrashButtons('brush')}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <div className="bg-orange-500 rounded-md">
          <button onClick={brushHundler('line')} className={classNamesBrashButtons('line')}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <div className="bg-orange-500 rounded-md">
          <button
            ...
            className="flex justify-center p-1 active:border-white rounded-md border-orange-500 border-2 border-solid">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
